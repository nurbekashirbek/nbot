...
def test_connection():
    ...
    try:
        ...
        if (
            ...
            return (
                False,
                "Database network is unreachable"
            )
